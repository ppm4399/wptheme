...
class WPCOM_Nav_Walker_Edit extends Walker_Nav_Menu_Edit {
	...
	public function start_el( &$output, $item, $depth = 0, $args = null, $id = 0 ) {
        if($item->url === '#pll_switcher' || $item->url === '#wpcom_user_info'){
		...
		<li id="menu-item-<?php echo $item_id; ?>" class="<?php echo implode(' ', $classes ); ?>">
			...
			<div class="menu-item-settings wp-clearfix" id="menu-item-settings-<?php echo $item_id; ?>">
                <menu-panel :level="level" item-id="<?php echo $item_id; ?>"><?php echo base64_encode(wp_json_encode($item));?></menu-panel>
