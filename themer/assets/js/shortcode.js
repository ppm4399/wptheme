(function ($) {
    ...
    tinymce.create("tinymce.plugins.wpcom_shortcodes", {
        init : function(ed, url) {
            ...
            $("body").append('<div class="wpcom-modal" id="sc-modal"><div class="modal-dialog modal-lg"><div class="modal-content"><div class="modal-header"><button type="button" class="wpcom-close" data-wpcom-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title">添加组件</h4></div><div class="modal-body" id="sc-iframe"></div></div></div></div>');
        },
        getInfo : function() {
            return {
