...
<div class="profile-tab-content active">
    ...
    if($follows && is_array($follows)){ ?>
        ...
        <?php if($total>$number) { ?><div class="load-more-wrap"><div href="javascript:;" class="wpcom-btn load-more j-user-follows"><?php _e( 'Load more posts', 'wpcom' );?></div></div><?php } ?>
    <?php }else{ ?>
...
<div class="profile-tab-content">
    ...
    <div class="load-more-wrap" style="display: none;"><div href="javascript:;" class="wpcom-btn load-more j-user-followers" data-page="0"><?php _e( 'Load more posts', 'wpcom' );?></div></div>
