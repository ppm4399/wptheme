...
class OneClickDemoImport {
  ...
  private $plugin_page_setup = array();
	...
	protected function __construct() {
        // Actions. WPCOM修改：setup_plugin_with_filter_data需要在主题加载数据后
		...
		add_action( 'admin_init', array( $this, 'setup_plugin_with_filter_data' ) );
	...
	public function admin_enqueue_scripts( $hook ) {
		...
		if ( 'admin.php' === $hook && $this->plugin_page_setup['menu_slug'] === esc_attr( $_GET['import'] ) ) {
	...
	public function import_demo_data_ajax_callback() {
		...
		ini_set( 'memory_limit', apply_filters( 'pt-ocdi/import_memory_limit', '512M' ) );
