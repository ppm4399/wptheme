...
<div id="reviews" class="woocommerce-Reviews">
    <div id="comments" class="entry-comments">
        ...
        <?php else : ?>
            ...
            <p class="woocommerce-noreviews"><?php esc_html_e( 'There are no reviews yet.', 'wpcom' ); ?></p>
        ...
        <div id="review_form_wrapper">
            <div id="review_form">
                ...
                if ( wc_review_ratings_enabled() ) {
                    $comment_form['comment_field'] = '<div class="comment-form-rating"><label for="rating" id="comment-form-rating-label">' . esc_html__( 'Your rating', 'woocommerce' ) . '</label><select name="rating" id="rating" aria-required="true" required>
    ...
    <?php else : ?>
        ...
        <p class="woocommerce-verification-required wpcom-alert alert-warning"><?php esc_html_e( 'Only logged in customers who have purchased this product may leave a review.', 'wpcom' ); ?></p>
